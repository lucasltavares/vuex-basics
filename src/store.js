   ...
   state: {
    ...
    getters: { // like computed
       ...
       registrations(state) {
        ...
        // map manually using this.$store.getters.methodname;
    },
    mutations: { // like methods (don't work asynchronously)
    ...
    actions: { // Acts as a middle-man, before you commit the mutation.
